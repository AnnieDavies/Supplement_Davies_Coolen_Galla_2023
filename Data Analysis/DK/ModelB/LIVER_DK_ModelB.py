'''
Code to perform data analysis on the LIVER data set in Davies, Coolen and Galla (2023) for delayed kernel model B.
...
def main_func(g):
    ...
    fileMin = fn_write + "G" + str(g+1) + "/MinimiseB_results.txt"
