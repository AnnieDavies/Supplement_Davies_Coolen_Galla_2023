'''
Code to perform data analysis on the AIDS data set in Davies, Coolen and Galla (2023) for delayed kernel model B.
...
def func(V, T, Z, Z_fix, X, N_train, p, n, Censor):
    function = 0.0
    #penalise for negative tau (NB: for AIDS data V[1] represents tau)
    if V[1]<0: 
